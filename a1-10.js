...
const LECTURA = {
  titulo: "A bad week for everyone",
  entradilla: "Media familia enferma a la vez. Cada párrafo cambia de paciente, así que verás <i>my head hurts</i> junto a <i>his back hurts</i> y <i>their throats hurt</i>, con el posesivo que el inglés exige siempre.",
  parrafos: [
    "Today I do not feel well. I have a headache and a sore throat, and my stomach hurts a little. I think I have a fever: I feel hot and cold at the same time. At night I cough a lot and I can't sleep.",
    "My grandfather is not well either. His back hurts every morning and he can't work in the garden. He says it is normal at eighty years old, but my mother does not agree. She calls Dr Reyes every week and she asks about him.",
    "Dr Reyes is our doctor and she is very patient. She listens to everybody, she looks at your eyes and your throat, and then she explains what you should do. She says I have the flu and she gives me pills for the headache. She also says I should never take pills without food.",
    "My cousins Pablo and Nico have a cold too. Their throats hurt and they cough all night, so their mother keeps them at home. We are all ill in the same week, and only Ana is healthy. She laughs at us and says we should sleep more. Tonight I go to bed early and I rest."
  ],
  glosario: [
    ["feel","fiːl","me siento","fíil"],
    ["hurts","hɜːrts","duele","jerts"],
    ["hurt","hɜːrt","duelen","jert"],
    ["cough","kɔːf","toso","kof"],
    ["says","sez","dice","ses"],
    ["agree","əˈɡriː","está de acuerdo","agríi"],
    ["calls","kɔːlz","llama","kols"],
    ["asks","æsks","pregunta","asks"],
    ["listens","ˈlɪsnz","escucha","lísns"],
    ["looks","lʊks","mira","luks"],
    ["explains","ɪkˈspleɪnz","explica","ikspléins"],
    ["gives","ɡɪvz","da","guivs"],
    ["keeps","kiːps","mantiene","kíips"],
    ["laughs","læfs","se ríe","lafs"],
    ...
    ["throats","θroʊts","gargantas","zróuts"],
    ["stomach","ˈstʌmək","estómago","stámak"],
    ["fever","ˈfiːvər","fiebre","fíivar"],
    ["flu","fluː","gripe","flúu"],
    ["cold","koʊld","resfriado","kóuld"],
    ["back","bæk","espalda","bak"],
    ["eyes","aɪz","ojos","áis"],
    ["pills","pɪlz","pastillas","pils"],
    ["doctor","ˈdɑːktər","médica","dáktar"],
    ["patient","ˈpeɪʃnt","paciente","péishnt"],
    ["healthy","ˈhelθi","sana","jélzi"],
    ["ill","ɪl","enfermos","il"],
    ...
    ["them","ðem","los","dem"],
    ["us","ʌs","de nosotros","as"],
    ["everybody","ˈevribɑːdi","a todos","évribadi"],
  ...
  preguntas: [
    { q:"What hurts David's grandfather?",
      ops:["His head","His back","His throat"], ok:1,
      pista:"Segundo párrafo: por eso no puede trabajar en el jardín." },
    { q:"What does Dr Reyes tell David about the pills?",
      ops:["That he should never take them without food","That he should take them at night","That he should not take any"], ok:0,
      pista:"Tercer párrafo, es el segundo consejo que le da." },
    { q:"Who is not ill?",
      ops:["The grandfather","Pablo and Nico","Ana"], ok:2,
      pista:"Último párrafo: es la única sana y se ríe de los demás." }
  ]
};
