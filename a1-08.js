...
const LECTURA = {
  titulo: "Two countries, two climates",
  entradilla: "David compara el clima de Honduras con el de Canadá. El texto alterna presente simple —para lo habitual— y presente continuo —para lo que pasa ahora—, que es justo la distinción de esta lección.",
  parrafos: [
    ...
    "Sarah says that Canada is very different. In winter it snows a lot and sometimes the temperature is minus twenty degrees. The sky is white for months and people wear big coats. She hates the humidity here, but I love the rain: it is cool and the air is clean after a storm. Right now it is raining outside and the wind is blowing hard, so we are waiting inside. It never rains for long."
  ],
  glosario: [
    ...
    ["inside","ˌɪnˈsaɪd","adentro","insáid"],
  ...
  preguntas: [
    ...
    { q:"What is happening outside right now?",
      ops:["It is raining and windy","It is sunny and warm","It is snowing"], ok:0,
      pista:"Busca el presente continuo al final del segundo párrafo: <i>right now</i>." },
    { q:"Why does David like the rain?",
      ops:["Because he needs a coat","Because it lasts a long time","Because it is cool and the air is clean"], ok:2,
      pista:"Lo explica justo después de decir <i>but I love the rain</i>." }
  ]
};
