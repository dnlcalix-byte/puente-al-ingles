...
const GLOSARIO_BASE = [
  ...
  /* Verbos y comodines de altísima frecuencia */
  ["be","biː","ser, estar","bi"],["as","æz","como, de","as"],
  ["think","θɪŋk","creo, pienso","zink"],["thinks","θɪŋks","cree","zinks"],
  ["bad","bæd","malo","bad"],["hard","hɑːrd","duro, fuerte","jard"],
  ["want","wɑːnt","quiero","uánt"],["wants","wɑːnts","quiere","uánts"],
  ["like","laɪk","gustar; como","láik"],["likes","laɪks","le gusta","láiks"],
  ["go","ɡoʊ","ir, voy","góu"],["goes","ɡoʊz","va","góus"],
  ["come","kʌm","venir, vengo","kam"],["comes","kʌmz","viene","kams"],
  ["see","siː","ver","síi"],["say","seɪ","decir","séi"],["says","sez","dice","ses"],
  /* Conectores y comodines que salen en casi todos los textos */
  ["I'd","aɪd","me gustaría","áid"],["I'm","aɪm","soy, estoy","áim"],
  ["it's","ɪts","es, está","its"],["that's","ðæts","eso es","dats"],
  ["answer","ˈænsər","respuesta","ánsar"],["question","ˈkwestʃən","pregunta","kuéschan"],
