...
const LECTURA = {
  titulo: "How everybody gets to school",
  entradilla: "Cada persona llega de una manera distinta. El texto practica los imperativos de una ruta y, sobre todo, <i>by bus</i>, <i>by car</i> y <i>on foot</i> en todas las personas.",
  parrafos: [
    "My school is not far from the main square. If you are at the square with the church, go along the main street to the traffic lights. At the lights, turn left and take the second street, not the first one: the first street is very small. Then go past the bank and cross the bridge. The school is at the end of that street, on the right.",
    "I come by bus every day and then I walk. The bus stop is opposite the park, near the pharmacy. It takes about ten minutes on foot from the square. I never go by car, because the traffic is always bad in the morning.",
    "Sarah lives near the centre, so she walks to school. She arrives first and she waits for us at the door. My cousins Pablo and Nico live far away: they take two buses and they are often late. Mr Ortega drives, but he leaves home at half past six to avoid the traffic.",
    "Mrs Castro does not go to school, but she opens her shop at seven, so she walks past the bridge every morning. If you get lost, ask her: she knows every street in this neighbourhood. We all arrive before nine, and nobody takes a taxi."
  ],
  glosario: [
    ["go","ɡoʊ","ve, voy","góu"],
    ["goes","ɡoʊz","va","góus"],
  ...
  preguntas: [
    { q:"How does Sarah get to school?",
      ops:["By bus","On foot","By car"], ok:1,
      pista:"Tercer párrafo: vive cerca del centro, y por eso llega la primera." },
    { q:"Why are Pablo and Nico often late?",
      ops:["Because they take two buses","Because they walk","Because they get lost"], ok:0,
      pista:"Tercer párrafo: viven lejos y su trayecto tiene un transbordo." },
    { q:"Why does Mr Ortega leave home at half past six?",
      ops:["Because the school opens early","To avoid the traffic","Because he walks slowly"], ok:1,
      pista:"La razón va justo después de la hora, con <i>to</i>." }
  ]
};
