...
const LECTURA = {
  titulo: "Jobs in my family",
  entradilla: "David repasa a qué se dedica cada uno en su familia. El texto está lleno del artículo obligatorio de profesión y de las tres preposiciones de <i>work</i>.",
  parrafos: [
    "My father is an accountant and he works in an office. He says his job is a bit boring, but the salary is good. My mother works as a teacher in a small school, part-time, from eight to one. She loves it because she works with little children. My grandfather is retired now; he was a farmer for forty years.",
    "My cousin works for a big company as a programmer. He is not a manager yet, but he earns a good salary. I am only a student for now, but after school I want to be a programmer too. It is not easy to learn, but I am interested in it and I am never bored in my computer class."
  ],
  glosario: [
    ...
    ["manager","ˈmænɪdʒər","gerente","mánayer"],
    ...
    ["hardest","ˈhɑːrdɪst","el más duro","járdest"],
    ...
    ["little","ˈlɪtl","pequeños","lítl"]
  ],
  preguntas: [
    { q:"Where does David's mother work?",
      ops:["In an office","In a small school","On a farm"], ok:1,
      pista:"Quien trabaja en una oficina es su padre." },
    { q:"What does David's cousin do?",
      ops:["He is a programmer","He is a manager","He is an accountant"], ok:0,
      pista:"Segundo párrafo: dice lo que es y lo que todavía no es." },
    { q:"Why is David never bored in his computer class?",
      ops:["Because the salary is good","Because it is easy","Because he is interested in it"], ok:2,
      pista:"Busca el adjetivo terminado en <i>-ed</i> que describe cómo se siente él." }
  ]
};
