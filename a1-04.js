...
const LECTURA = {
  titulo: "My street",
  entradilla: "David describe su casa y su barrio. El texto está construido sobre <i>there is / there are</i> y las preposiciones de lugar, con y sin artículo según corresponda.",
  parrafos: [
    "I live in a small house on the corner of a quiet street. There are five rooms: three bedrooms, a kitchen and a living room. The kitchen is next to the dining room. Behind the house there is a garden. There aren't any trees in the garden, but there are some flowers. We do not have a garage because we do not have a car.",
    "My neighbourhood is very good. There is a supermarket between the bank and the pharmacy, and the bus stop is opposite the park. The church is on the same street. I walk to school every day; it is only ten minutes from here. Houses are expensive near the centre, so we are lucky. My parents love this neighbourhood and I love it too."
  ],
  glosario: [
    ["live","lɪv","vivo","liv"],
    ["walk","wɔːk","camino","uók"],
    ["love","lʌv","adoran, adoro","lav"],
    ...
    ["houses","ˈhaʊzɪz","casas","jáusis"],
    ["expensive","ɪkˈspensɪv","caras","ikspénsiv"],
    ["centre","ˈsentər","centro","sénter"],
    ["lucky","ˈlʌki","afortunados","láki"],
    ["quiet","ˈkwaɪət","tranquila","kuáiet"],
    ["same","seɪm","misma","séim"],
    ["school","skuːl","escuela","skúul"],
    ["minutes","ˈmɪnɪts","minutos","mínits"],
    ["because","bɪˈkɔːz","porque","bicós"],
    ["so","soʊ","así que","sóu"],
    ["aren't","ɑːrnt","no hay, no son","arnt"],
    ["neighbourhood","ˈneɪbərhʊd","barrio","néibarjud"],
    ["parents","ˈperənts","padres","pérents"],
    ["every day","ˈevri deɪ","cada día","évri déi"]
  ],
  preguntas: [
    { q:"How many bedrooms are there in David's house?",
      ops:["Five","Three","Two"], ok:1,
      pista:"Hay cinco habitaciones en total, pero no todas son dormitorios." },
    { q:"Where is the bus stop?",
      ops:["Opposite the park","Between the bank and the pharmacy","Behind the house"], ok:0,
      pista:"Segundo párrafo: lo que está entre el banco y la farmacia es otra cosa." },
    { q:"Why doesn't David's family have a garage?",
      ops:["Because the house is small","Because it is expensive","Because they do not have a car"], ok:2,
      pista:"Final del primer párrafo: la razón la da él mismo con <i>because</i>." }
  ]
};
