...
const LECTURA = {
  ...
  entradilla: "Una mañana de compras en el mercado. El texto practica los precios, los demostrativos <i>this/these/that/those</i>, <i>too</i> frente a <i>enough</i>, y el verbo <i>can</i> en tres personas distintas.",
  parrafos: [
    "On Saturday morning I go to the market with my sister Ana. There is a discount every Saturday, so the prices are cheaper. Last week I wanted a blue shirt, but it was twenty-five dollars. That was too expensive for me, so I did not buy it. This week the same shirt is fifteen dollars, and that is cheap enough.",
    "Mr. Ortega sells fruit near the door. He opens his shop at six and he knows all the prices by heart. \"How much are these oranges?\" Ana asks. He answers, \"Two dollars a kilo. Those bananas are cheaper today.\" He never uses a calculator; he counts the change in his head.",
    "Pablo and Nico come to the market too. They want new shoes, but they do not have enough money today. They look at the shoes, they ask the price twice, and then they walk away. \"We can come back next month,\" Nico says. \"These shoes are too expensive for us.\"",
    "Ana always asks the price before she buys anything. She never pays by card here; she prefers cash. Today we have enough money for the shirt and an umbrella, and we still have change. Mr. Ortega gives her a free mango because she is a good customer."
  ],
  glosario: [
    ["go","ɡoʊ","voy","góu"],
    ["buy","baɪ","comprar","bái"],
    ...
    ["sells","selz","vende","sels"],
    ["opens","ˈoʊpnz","abre","óupns"],
    ["counts","kaʊnts","cuenta","káunts"],
    ["gives","ɡɪvz","da, regala","guivs"],
    ["uses","ˈjuːzɪz","usa","iúsis"],
    ["walk away","wɔːk əˈweɪ","irse","uók auéi"],
    ["come back","kʌm bæk","volver","kam bak"],
    ["look at","lʊk æt","mirar","luk at"],
    ["pays","peɪz","paga","péis"],
    ...
    ["too expensive","tuː ɪkˈspensɪv","demasiado caro","túu ikspensiv"],
    ...
    ["cheaper","ˈtʃiːpər","más barato","chíiper"],
    ["discount","ˈdɪskaʊnt","descuento","dískaunt"],
    ["change","tʃeɪndʒ","cambio, vuelto","chéinch"],
    ["cash","kæʃ","efectivo","kash"],
    ["card","kɑːrd","tarjeta","kard"],
    ["shoes","ʃuːz","zapatos","shúus"],
    ["shirt","ʃɜːrt","camisa","shert"],
    ["umbrella","ʌmˈbrelə","paraguas","ambréla"],
    ["oranges","ˈɔːrɪndʒɪz","naranjas","órinchis"],
    ["bananas","bəˈnænəz","bananos","banánas"],
    ["mango","ˈmæŋɡoʊ","mango","mángou"],
    ["fruit","fruːt","fruta","frút"],
    ["kilo","ˈkiːloʊ","kilo","kílou"],
    ["calculator","ˈkælkjuleɪtər","calculadora","kálkiuleitar"],
    ["customer","ˈkʌstəmər","cliente","kástamar"],
    ["sister","ˈsɪstər","hermana","sístar"],
    ["free","friː","gratis","frí"],
    ["by heart","baɪ hɑːrt","de memoria","bai jart"],
    ["head","hed","cabeza","jed"],
  ...
  preguntas: [
    { q:"Why didn't David buy the shirt last week?",
      ops:["Because the market was closed","Because it was too expensive","Because it was too big"], ok:1,
      pista:"Primer párrafo: costaba veinticinco dólares y él usa <i>too expensive</i>." },
    { q:"What do Pablo and Nico do in the end?",
      ops:["They buy the shoes","They ask for a discount","They walk away without the shoes"], ok:2,
      pista:"Tercer párrafo: no tienen <i>enough money</i>, así que..." },
    { q:"How does Ana pay at the market?",
      ops:["In cash","By card","She does not pay"], ok:0,
      pista:"Cuarto párrafo: dice qué prefiere y qué nunca hace." }
  ]
};
